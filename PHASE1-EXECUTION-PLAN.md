...
NEXT EXACT TASK:       D1 — `Controls` dataclass + pinning helpers (session headers, cache-buster, ordering,
                       ...
                       inconclusive. NOT yet started. Group C (C1-C8) is now fully complete, and two
                       rounds of retrospective C1-C8 audit fixes (below) are also complete — D1 remains
                       the next new task; it was not started as part of either audit-fix round.
