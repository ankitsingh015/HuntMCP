...
| Phase 2.8 — claude-bug-bounty-derived backlog | 🔶 In progress | Scope-enforcement hook, OOB listener (`oob-mcp`), WAF bypass tooling (`waf-bypass-mcp`) all done; HackerOne read-only MCP still open |
